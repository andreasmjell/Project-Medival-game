...
public class InputManager{
    ...
    public void bindDefault(){
        ...
        //esc
        this.bindKey(27, () -> gameContext.mapController.openPauseMenu()); //Åpner main menu. !! Må byttes til pause overlay. Starter flere game loops!
        //Movement----------------------
        //pil opp
        this.bindKey(38, () -> gameContext.camera.y -= 15);
        //pil ned
        this.bindKey(40, () -> gameContext.camera.y += 15);
        //pil venste
        this.bindKey(37, () -> gameContext.camera.x -= 15);
        //pil høyre
        this.bindKey(39, () -> gameContext.camera.x += 15);
        //venstre control hold for å legge til destinasjon på path
        this.bindKey(17, () -> gameContext.player.setAddToPath()); //Funkgerer dårlig!!
        ...
        //Komma (zoom in)
        this.bindKey(44, () ->  gameContext.camera.zoomIn());
        //Punktum (zoom ut)
        this.bindKey(46, () -> gameContext.camera.zoomOut());
